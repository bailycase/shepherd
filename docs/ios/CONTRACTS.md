...
| Pencil markup | `DesignPad/PadDesignMarkup.swift` (K, filled by P5d) | `PadDesignCanvasView`, over the canvas | `PadDesignMarkupLayer(context: PadDesignMarkupContext)`; the canvas leaves `.pencil` touches to it |
