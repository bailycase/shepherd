...
/// Installs the per-session pi extension that hot-reloads Shepherd's generated
/// pi theme file into every agent TUI.
enum ThemeExtension {
    static func installedPath() throws -> String {
        let directory = ShepherdPaths.supportDirectory()
        try FileManager.default.createDirectory(at: directory, withIntermediateDirectories: true)
        let url = directory.appendingPathComponent("shepherd-theme.ts")
    ...
    /// Extensions/shepherd-theme.ts is canonical; keep this byte-identical.
