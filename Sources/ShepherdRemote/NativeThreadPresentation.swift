...
public func nativeTurns(_ messages: [NativeThreadMessage], aliases: [String: String] = [:]) -> [NativeTurn] {
    ...
    for message in messages where message.role == "user" || message.compaction != nil || message.question != nil || (message.role != "system" && (message.toolName != nil
...
public func nativeFirstSentence(_ text: String, limit: Int = 72) -> String {
