...
// per burst of same-kind work, with the calls behind it. Pure derivations: every string a line,
// its calls, or the turn's changes card shows is built here once per turn, never in a view body.
